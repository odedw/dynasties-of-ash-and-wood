# The Willowshore Ruling Family

*De facto rulers of a forgotten village, now facing an unwelcome change of power.*
...
For generations, Willowshore was a forgotten place—too small and poor to warrant attention from [Shogun Tsuneni's](../npcs/shogun-tsuneni.md) regime in Jyito. In the absence of oni rule, a local family rose to become the de facto rulers, managing the village's affairs and maintaining order.

Now, with a new oni mayor arriving to claim authority, the family's position is threatened. They have refused to participate in the traditional [Revival of Friendship](../locations/willowshore.md#the-revival-of-friendship)—a ceremony meant to publicly put old grudges to rest and recognize the transfer of power.

---

## The Family's Shame

The ruling family carries a secret shame connected to [the oldest story about the forest shadows](../locations/willowshore.md#the-forest-story). The tale's ending is never spoken aloud because it embarrasses them:

> The heir to the family fortune was said to have been "lured away by forest spirits." In truth, he simply got drunk and wandered into the woods. The father—a teetotaler—spun the yarn about spirits to save face, and the family has maintained the fiction ever since.

This deception has created factions within Willowshore. Some villagers resent the family's dishonesty; others welcomed the oni's arrival as a chance to unseat the old rulers.

---

## Current Situation

The family's refusal to perform the Revival of Friendship is an act of quiet defiance—an unofficial protest against the oni's claim to have "always been here." But their position is precarious. They have lost their monopoly on power, and their old secrets may yet come to light.

With [Magistrate Kurosawa's](../npcs/magistrate-kurosawa.md) arrival, the family has been displaced from their estate entirely. They are now staying at **Silver Mist Lodge**, a faded inn on the riverside, while the magistrate occupies their former home. This public humiliation has only deepened their resentment.

The magistrate considered them the prime suspects for the warehouse fire that destroyed festival preparations. This suspicion proved correct: [Mido](../npcs/mido.md), the family matriarch, admitted that "more brash" family members hired [Hong](../npcs/hong.md) to destroy the fireworks as a sabotage against the festival. She promised the party that all further planned disruptions would be canceled.

The family is also **actively surveilling** [Magistrate Kurosawa](../npcs/magistrate-kurosawa.md), having tracked his repeated visits to the [Mourndusk Willow](../locations/dark-woods.md) in the Dark Woods. The glen where the tree stands is connected to a tragedy in the family's past.
...
### Opposition
- The new oni mayor
- Villagers who welcomed the oni's arrival
...
- Established through world-building as Willowshore's de facto rulers
- Their refusal to participate in the Revival of Friendship established
- The secret of the "lost heir" and the forest story created
- Connected to Littlefinger's backstory

### Session One (2026-01-30)
- Displaced from their estate by [Magistrate Kurosawa](../npcs/magistrate-kurosawa.md)
- Now residing at Silver Mist Lodge
- Named by the magistrate as prime suspects for the warehouse fire
- The party has been tasked with investigating them

### Session Two (2026-02-05)
- [Mido](../npcs/mido.md), the matriarch, formally introduced; received the party in her suite at Silver Mist Lodge
- Admitted to sponsoring the warehouse sabotage via [Hong](../npcs/hong.md); called it a "foolish endeavor"
- Promised to cancel all other planned disruptions in exchange for the party's honesty
- Honored the 100 gold payment to Hong
- Revealed intelligence about Kurosawa's secret visits to the [Mourndusk Willow](../locations/dark-woods.md)
...
- [Mido](../npcs/mido.md) received Ginkgo and Donkey for a second audience; analyzed the ritual findings from the Mourndusk Willow
...
- Mido's intelligence network continues to monitor the magistrate's movements
...
- [Mido](../npcs/mido.md) revealed the **Gosembiki** (五芒星, Five Pointed Star)—haunted ruins east of town that Kurosawa has named and recently visited
- [Cheng Yesho](../npcs/the-smiling-one.md) identified as Mido's brother and a military veteran; his Chthonic language skills translated the Gosembiki name
- Littlefinger returned Cheng's military medal (stolen from the estate); the family was appreciative
- **Agreed to provide an alibi** for the party—stating they were present for a family vote during the festival
- Mido confirmed the pattern of fives (ley lines, lanterns, Gosembiki) and expressed belief that the spirits of the land are unhappy
...
- **Sentenced to exile in five days** by [Magistrate Kurosawa](../npcs/magistrate-kurosawa.md), who claims they stole items vital to the Imperium and the **Council of the Magi**; a carriage will arrive to transport them
- [Mido](../npcs/mido.md) described the legal situation as grim—"trials of fairness" are not something the oni handle regularly
- The family has discussed **contingency plans** for escape if the exile cannot be prevented
- [Cheng](../npcs/the-smiling-one.md) revealed knowledge of the **old gods** and the **Battle of Five Crows**, exchanging loaded glances with Mido before answering the party's questions
...
- The network produced three finds: the identity of **[Otsuru](../npcs/atsura.md)** (a new Council magistrate in town), **[Kurosawa's](../npcs/magistrate-kurosawa.md) departure** for [Cloudbreaker Cairn](../locations/cloudbreaker-cairn.md), and — via agents sent to [Kirahata](../locations/kirahata.md) — **[Masru's](../npcs/mayor-masru.md) disgraced past and Kurosawa-signed commission**
