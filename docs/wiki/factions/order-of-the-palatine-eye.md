...
*"When the town closes its hand against you, seek the eye that opens."*
...
| | |
|---|---|
| **Type** | Occult investigator order (legendary, presumed extinct) |
| **Headquarters** | A site in the **mountains roughly 40–50 miles south of [Willowshore](../locations/willowshore.md)** — exact location ingrained in [Da Baishan's](../pcs/da-baishan.md) memory by [Vujravati's](../npcs/vujravati.md) gift |
| **Status** | According to common occult knowledge, **wiped out**; their lore is *"lost to the continent, lost to the world."* Whether anyone remains is unknown. |

---

## Description

The Order of the Palatine Eye is a **legendary occult-investigator order** — described in surviving occult studies as the *"SSA or CIA of occult investigations"* — a body of elite practitioners who studied, catalogued, and confronted the ancient gods, lost traditions, and forbidden practices that other groups would not touch.

In their day they were one of the foremost authorities in the world on:

- Ancient and "buried" gods
- Old chthonic traditions and rites that pre-date the imperial pantheon
- The arcane and occult techniques that other orders considered too dangerous to preserve
- Long-running, slow corruptions of the kind Vujravati now calls *"the rot spreading"*

The standard occult-history line is that **the Order has been wiped out** — their archives lost, their members destroyed, their lore scattered. Whether this is true, or whether some remnant persists in the mountain stronghold the party is now headed toward, is the open question.

---

## Da Baishan's Mark and the Path South

[Vujravati](../npcs/vujravati.md) gave [Da Baishan](../pcs/da-baishan.md) — alone among the party — a gift that was *not* a tangible object. In Session Nine, Da Baishan finally made the **Occultism check (21)** that revealed what the gift actually was:

- A token tied to the **Order of the Palatine Eye**
- The vision he had been carrying — *"like a Google map, zoomed out from your location to a spot you know exactly"* — is a **fixed location** in the mountains, ~40–50 miles south of Willowshore
- The poetic phrasing he was given — *"When the town closes its hand against you, seek the eye that opens"* — refers to that site

The Order is the only direct lead the party currently has on **how to fight Kurosawa's chthonic geomancy**. If anyone or anything remains there, they are likely the only people on the continent who would still recognize the **Mother of a Thousand Wings** rite by name and know how to break it.

---

## Why It Matters

[Kurosawa](../npcs/magistrate-kurosawa.md) is a magi-grade geomancer working ritual that, by [Mido's](../npcs/mido.md) own admission, is **beyond her ability to counter**. The dragon [Vujravati](../npcs/vujravati.md) has explicitly refused to be the party's shield. The mayor has been swayed and the Council of the Magi is, in Kurosawa's own words, *himself*.

The Order of the Palatine Eye is, in effect, the campaign's only present lead on **counter-knowledge** for what Kurosawa is doing. Whether the lead resolves into living allies, a buried archive, a guardian spirit, a trap, or a memorial is unknown.

---

## Open Questions

- Is anyone there? Or only ruins?
- If it is ruins — how comprehensively were they destroyed? Did anything survive in caches the way [Shen Takashi's](../npcs/shen-takashi.md) sword survived under Gosembiki?
- Why did Vujravati direct *Da Baishan* to it, specifically?
- Is the Order's silence the work of the same "rot" Vujravati witnesses, or of a separate enemy?
- Does the Order have any connection to the **five old gods** [Cheng Yesho](../npcs/the-smiling-one.md) named?
...
- [Da Baishan](../pcs/da-baishan.md) made the Occultism check (21) on his Vujravati gift; identified the token as a marker of the Order of the Palatine Eye
...
- **The Order received a message from its dead.** When [Da Baishan](../pcs/da-baishan.md) restored [Cassian Voss's](../npcs/cassian-voss.md) name to the third cedar, Voss's fading spirit spoke to him alone: ***"Tell the Order — it was not the oni."*** Da Baishan's dry acknowledgment of the Order's current membership problem: *"Now, if only I knew anyone else in this Order"*
- The message is the Order's first hard directive since the Vault: the **second hand** at the cedars — the erasure, the powder, the older ritual the GM's closing recap tied *"to Cassian Voss and the Order"* — is **not Kurosawa and not oni work.** Two of the Order's people (Voss dead, Da Baishan living) have now converged on the same unknown adversary
- Da Baishan discovered his **On the Case** feat mid-session (*"I treat my adventures as mysteries"*) — Devise a Stratagem justified by the standing investigation, very much in the Order's house style — and his Order-trained **Occultism 27** produced the transfusion analysis of the [Grandmother's seed](../npcs/the-grandmother.md#the-seed-the-plum)
- The eye glowed again during that analysis — *"divine inspiration from the Order... it whispers to you, writes some entry into the book"* — the first suggestion that the Order's knowledge is being **actively fed** to its last detective
