...
- *David back at the table — and back inside the dream he'd been dropped into by proxy*
- **Read the prison in one roll.** Arcana 24 at session open: the five lanterns are anchors of an **imprisonment ward**, the water inside them has depth and a **golden koi** swimming in it, the arcane lines between the lanterns are visible to him alone, and the Mother of a Thousand Wings is the **warden**. *"Sounds like we need to destroy the lanterns"* — the whole fight's plan, first breath
- **Watched Littlefinger die.** Failed a Will save (18) against the warden's Draconic spell and, at the GM's invitation, **narrated his own nightmare**: the wound yellowing, turning to moths, the body absorbed. 12 mental damage, frightened 1. *"So I believe Littlefinger is dead."* — *"If you saw a vision of it."* On the massage bed, his heart stopped for two seconds
- **Sleep on a nightmare** (DC 20) — the moth rolled 35. Fled to a lantern. Ignition missed a thread; tried to **break a filament with his bare hands** — twice — and got a piano-wire *"C-major tone"* for his trouble. The first melee attacks of his career
- **Held against the shriek** while both companions failed — *"I was hoping Donkey would also be stupefied. Nope, he can still cast his spells"* — and paid the GM back immediately with **Dizzying Colors** (DC 20): the moth **critically failed** — stunned 1, blinded, dazzled. *"I don't know why I didn't think of this at first, considering it's a bunch of moths."* Da Baishan: *"The bug zapper"*
- **Cut the last tether with a natural 20.** Ignition through a gap in the swarm (30 total) — the thread burned, the fifth lantern died, the warden dissolved, and the dam broke. The killing blow on the veil
- **Gave the spirit permission**: Old Amber — *"Can I consume the plum?"* — Donkey: *"Sure, bud."* Then a Nature check on plums, for form's sake
- Connected Old Amber's *"smiles from behind a door"* to the ruling family before anyone said the name: *"It sounds like he's talking about the old ruling family"*
- **The party skeptic on Atsura**: *"She hands us our freedom on a silver platter, and there's this other curse Kurosawa was investigating... she's up to something. I think we need to know more about this old curse before we do any deals with her."* Also the one who muttered *"for now"* when she vouched that the party would stay inside the borders
- Proposed the evening's cover: a **private session at Willow's** with invited guests — *"get everybody nice and relaxed and just have a friendly chat"* — and seizing Masru's note under the party's investigative licenses (*"I think we can just seize it"*)
- Opened the Mido audience: *"We'd like to talk to you about something Old Amber said... an older trouble, older than the curse that was just lifted."* Perception 27 on Cheng during Littlefinger's interrogation: nothing moved
- Rules note: *"I think more rolls should be hidden from the players. Like perception checks"* — the GM agreed to try it. Also the only party member who can't heal anyone: *"you could be receiving everybody's healing"*
