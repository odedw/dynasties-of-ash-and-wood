...
*Five Pointed Star — where the ley lines converge and the land remembers what it was told to forget.*
...
| | |
|---|---|
| **Name** | Gosembiki (五芒星) — the Five Pointed Star |
| **Type** | Ancient ruins |
| **Location** | ~10–15 miles east of [Willowshore](willowshore.md), in the grassland plains along the river |
| **Status** | Abandoned; avoided by locals; recently investigated by [Magistrate Kurosawa](../npcs/magistrate-kurosawa.md) |

---

## Description

The Gosembiki ruins are a cluster of dilapidated buildings visible from several miles away, jutting from the open grasslands east of Willowshore. The site consists of multiple structures—not a single building—suggesting it was once a settlement, temple complex, or ritual site of some significance.

Few locals visit or speak of it. [Mido](../npcs/mido.md) described it as "broken down" with "nothing really of value"—a place people avoid for reasons they cannot fully articulate. The name **Gosembiki** (五芒星, Five Pointed Star) was given by [Magistrate Kurosawa](../npcs/magistrate-kurosawa.md) in the Chthonic tongue and translated by [Cheng Yesho](../npcs/the-smiling-one.md).

---

## Significance

The ruins are believed to be a **convergence point**—arcane, chthonic, possibly connected to the five ley lines that run beneath Willowshore and the surrounding region. A **map and device diagram** found among [Kurosawa's](../npcs/magistrate-kurosawa.md) papers marks this location, and the device sketch matches the apparatus [Yong](../npcs/yong.md) was commissioned to build.

[Cassian Voss](../npcs/cassian-voss.md), the deceased researcher from Absalom, had planned to **head east** following the ley lines along the rivers—a path that would have led him directly to these ruins.

---

## Approach

The journey from Willowshore takes several hours on foot, following the river east. The terrain transitions from forest to sparse woodland to open grassland. The ruins become visible from about three to four miles away—a dark silhouette against the plains.
...
- [Mido](../npcs/mido.md) revealed the existence of the Gosembiki—haunted ruins east of Willowshore that [Kurosawa](../npcs/magistrate-kurosawa.md) has named and recently traveled to
- A stolen map from Kurosawa's desk marks the location with a device diagram

### Session Six (2026-03-19)
- The party trekked east along the river toward the ruins
